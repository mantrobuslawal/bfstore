# Fine-Grained Application Authorisation
...
bfstore will evaluate policy-backed fine-grained authorisation for user/resource decisions where application complexity justifies it.
