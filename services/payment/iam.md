...
Define AWS IAM and runtime identity requirements for the `payment` service.

## Scope

Applies to `payment` deployment, Kubernetes service account, AWS workload role and secret access.
...
- Read payment provider secrets.
- Use strict KMS/secrets permissions.
- Higher audit sensitivity than normal services.
