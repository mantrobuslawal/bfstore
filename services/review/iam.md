...
Define AWS IAM and runtime identity requirements for the `review` service.

## Scope

Applies to `review` deployment, Kubernetes service account, AWS workload role and secret access.
...
- Read review database secret.
- Enforce user/resource authorisation.
- No access to order/payment secrets.
