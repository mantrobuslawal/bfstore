...
Define AWS IAM and runtime identity requirements for the `inventory` service.

## Scope

Applies to `inventory` deployment, Kubernetes service account, AWS workload role and secret access.
...
- Read inventory database secret.
- Publish inventory adjustment/reservation events.
