...
Define AWS IAM and runtime identity requirements for the `notification` service.

## Scope

Applies to `notification` deployment, Kubernetes service account, AWS workload role and secret access.
...
- Read notification provider secrets.
- Consume relevant domain events.
