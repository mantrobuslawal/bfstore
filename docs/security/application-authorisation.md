...
Define application-level authorisation boundaries.
...
- Infrastructure IAM does not replace app authorisation.
- Service-to-service and user-to-resource permissions must be explicit.
- Document ownership checks for order, payment, inventory and admin actions.
